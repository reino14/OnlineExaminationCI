...
class Ujian extends CI_Controller {
	...
	public function simpan_akhir()
	{
		...
		$jumlah_salah  = 0;
		$jumlah_ragu   = 0;
		$nilai_bobot   = 0; // Menyimpan total bobot
		...
		foreach ($pc_jawaban as $jwb) {
			...
			$nilai_bobot = $nilai_bobot + $cek_jwb->bobot; // Menambahkan bobot setiap soal
