...
<aside class="main-sidebar">
	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu" data-widget="tree">
			...
			<?php endif; ?>
			<?php if( $this->ion_auth->in_group('Student') ) : ?>
			<li class="<?=$page==='E-books'?"active":""?>">
				<a href="<?=base_url('ujian/buku')?>" rel="noopener noreferrer">
					<i class="fa fa-book"></i> <span>E-books</span>
				</a>
			</li>
			...
			<li class="<?=$page==='Banksoal'?"active":""?>">
				<a href="<?=base_url('ujian/banksoal')?>" rel="noopener noreferrer">
